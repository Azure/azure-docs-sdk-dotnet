...
**Hosting**: To run code you’ve written to run in Azure, it needs to be hosted in a service that supports executing user-provided code.
...
> [!TIP]
> For a more complete list see [Overview of Azure compute options](https://docs.microsoft.com/azure/architecture/guide/technology-choices/compute-overview#azure-compute-options).
...
> [!TIP]
> For more information, see [Decision tree for Azure compute services](https://docs.microsoft.com/azure/architecture/guide/technology-choices/compute-decision-tree).
...
* [Get started with the Azure .NET and .NET Core APIs](dotnet-sdk-azure-get-started.md)
* [Azure Quick Start Guide for .NET Developers free e-book](https://www.microsoft.com/net/download/thank-you/azure-quick-start-ebook)
