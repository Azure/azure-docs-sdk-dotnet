...
---
# Azure Container Registry Management client library for .NET - version 1.0.2 
...
To create an authenticated client and start interacting with Azure resources, please see the [quickstart guide here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.ContainerRegistry_1.0.2/doc/dev/mgmt_quickstart.md)
...
- [Quickstart](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.ContainerRegistry_1.0.2/doc/dev/mgmt_quickstart.md)
- [API References](/dotnet/api/?view=azure-dotnet)
- [Authentication](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.ContainerRegistry_1.0.2/sdk/identity/Azure.Identity/README.md)
