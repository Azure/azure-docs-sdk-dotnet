---
title: Service-to-service authentication to Azure services using .NET
description: Use the Microsoft.Azure.Services.AppAuthentication library to authenticate to services using .NET.
