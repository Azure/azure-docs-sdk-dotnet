...
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.Applications.Containers, containerapps
author: ramya-rao-a
ms.author: ramyar
ms.date: 05/24/2022
ms.topic: reference
...
---
# Azure ContainerApps Management client library for .NET - Version 1.0.0-alpha.20220523.2 
...
Install the Azure Container Apps management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Applications.Containers --prerelease
```
