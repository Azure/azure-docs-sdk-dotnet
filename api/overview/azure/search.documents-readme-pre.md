...
keywords: Azure, .net, SDK, API, Azure.Search.Documents, 
author: maggiepint
ms.author: magpint
ms.date: 06/09/2020
ms.topic: article
...
# Azure Cognitive Search client library for .NET - Version 1.0.0-preview.4 
...
Install the Azure Cognitive Search client library for .NET - Version 1.0.0-preview.4 
 with [NuGet][nuget]:
