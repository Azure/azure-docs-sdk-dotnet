...
# Azure Communication Services management client library for .NET - version 1.0.0 
...
SDK](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.Communication_1.0.0/doc/mgmt_preview_quickstart.md).
