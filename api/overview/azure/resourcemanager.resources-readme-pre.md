...
keywords: Azure, .net, SDK, API, Azure.ResourceManager.Resources, 
author: maggiepint
ms.author: magpint
ms.date: 06/22/2020
ms.topic: article
...
# Azure Resources Management client library for .NET - Version 1.0.0-preview.1 
...
```PowerShell
Install-Package Azure.ResourceManager.Resources -Version 1.0.0-preview.1 
```
