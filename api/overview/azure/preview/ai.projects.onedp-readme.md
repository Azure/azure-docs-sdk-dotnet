---
title: Azure OneDP client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.AI.Projects.OneDP, ai
ms.date: 04/17/2025
ms.topic: reference
ms.devlang: dotnet
ms.service: ai
---
# Azure OneDP client library for .NET - version 1.0.0-alpha.20250417.1 
