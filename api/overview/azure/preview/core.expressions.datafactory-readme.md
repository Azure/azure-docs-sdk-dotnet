...
ms.service: core
---
# Azure Core Expressions DataFactory shared client library for .NET - version 1.1.0-beta.1 
...
Three main ways of troubleshooting failures are [inspecting exceptions](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core.Expressions.DataFactory_1.1.0-beta.1/sdk/core/Azure.Core/samples/Response.md#handling-exceptions), enabling [logging](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core.Expressions.DataFactory_1.1.0-beta.1/sdk/core/Azure.Core/samples/Diagnostics.md#Logging), and [distributed tracing](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core.Expressions.DataFactory_1.1.0-beta.1/sdk/core/Azure.Core/samples/Diagnostics.md#Distributed-tracing)
...
[source]: https://github.com/Azure/azure-sdk-for-net/tree/Azure.Core.Expressions.DataFactory_1.1.0-beta.1/sdk/core/Azure.Core/src
