...
ms.service: dns
---
# Azure DNS Management client library for .NET - version 1.0.0-beta.2 
...
- Setting [Environment Variables](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.Dns_1.0.0-beta.2/sdk/resourcemanager/Azure.ResourceManager/docs/AuthUsingEnvironmentVariables.md).
...
Key concepts of the Azure .NET SDK can be found [here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.Dns_1.0.0-beta.2/sdk/resourcemanager/Azure.ResourceManager/README.md#key-concepts)
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.Dns_1.0.0-beta.2/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
