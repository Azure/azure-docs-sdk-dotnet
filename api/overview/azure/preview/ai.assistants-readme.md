---
title: Azure AI Assistants client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.AI.Assistants, ai
ms.date: 04/08/2025
ms.topic: reference
ms.devlang: dotnet
ms.service: ai
---
# Azure AI Assistants client library for .NET - version 1.0.0-alpha.20250407.2 
...
To use Azure AI Assistants capabilities, you must have an [Azure subscription](https://azure.microsoft.com/free/dotnet/). This will allow you to create an Azure AI resource and get a connection URL.
...
```C# Snippet:AssistantsReadme_Troubleshooting
try
{
