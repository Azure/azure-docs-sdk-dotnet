...
To create an authenticated client and start interacting with Microsoft Azure resources, see the [quickstart guide here](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.LargeInstance_1.0.0-beta.1/doc/dev/mgmt_quickstart.md).
...
- [Quickstart](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.LargeInstance_1.0.0-beta.1/doc/dev/mgmt_quickstart.md).
- [API References](/dotnet/api/?view=azure-dotnet).
- [Authentication](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.LargeInstance_1.0.0-beta.1/sdk/identity/Azure.Identity/README.md).
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.LargeInstance_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
