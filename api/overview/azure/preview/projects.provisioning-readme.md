...
keywords: Azure, dotnet, SDK, API, Azure.Projects.Provisioning, cloudmachine
ms.date: 04/08/2025
ms.topic: reference
ms.devlang: dotnet
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Projects.Provisioning_1.0.0-beta.1/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
