...
---
# Azure Provisioning client library for .NET - version 0.1.0-beta.2 
...
<!-- LINKS -->
[cg]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Provisioning_0.1.0-beta.2/sdk/resourcemanager/Azure.ResourceManager/docs/CONTRIBUTING.md
