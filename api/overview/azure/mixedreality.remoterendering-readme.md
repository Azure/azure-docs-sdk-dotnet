...
# Azure Remote Rendering client library for .NET - Version 1.0.0 
...
[Mixed Reality STS service](https://github.com/Azure/azure-sdk-for-net/tree/Azure.MixedReality.RemoteRendering_1.0.0/sdk/mixedreality/Azure.MixedReality.Authentication)
