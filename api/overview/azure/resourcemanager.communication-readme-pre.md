...
keywords: Azure, .net, SDK, API, Azure.ResourceManager.Communication, 
author: maggiepint
ms.author: magpint
ms.date: 09/22/2020
ms.topic: article
...
# Azure Communication Services management client library for .NET - Version 1.0.0-beta.1 
...
SDK](https://github.com/Azure/azure-sdk-for-net/blob/Azure.ResourceManager.Communication_1.0.0-beta.1/doc/mgmt_preview_quickstart.md).
