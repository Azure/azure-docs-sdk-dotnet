...
# Azure Storage Files Data Lake client library for .NET - Version 12.3.0-preview.1 
...
Install the Azure Storage Files Data Lake client library for .NET - Version 12.3.0-preview.1 
 with [NuGet][nuget]:
