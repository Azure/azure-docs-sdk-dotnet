...
More on long-running operations in [long-running operation samples](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Core_1.16.0/sdk/core/Azure.Core/samples/LongRunningOperations.md)
