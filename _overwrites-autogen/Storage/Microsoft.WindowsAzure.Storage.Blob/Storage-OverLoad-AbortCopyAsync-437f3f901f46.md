---  
uid: Microsoft.WindowsAzure.Storage.Blob.CloudBlockBlob.AbortCopyAsync  
remarks: *content  
---  
  
## Remarks  
 The AbortCopyAsync method aborts a copy operation, leaving a destination blob with zero length and complete metadata. Use the copy ID returned by the [StartCopyAsync](assetId:///Overload:Microsoft.WindowsAzure.Storage.Blob.CloudBlockBlob.StartCopyAsync?qualifyHint=False&autoUpgrade=True) method to abort the copy operation.  
